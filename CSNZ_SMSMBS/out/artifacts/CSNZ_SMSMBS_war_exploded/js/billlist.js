...
function deleteBill(obj){
	$.ajax({
		type:"GET",
		url:path+"/Bill/deleteBill/"+obj.attr("billid"),
		data:{},
		dataType:"json",
...
$(function(){
	$(".viewBill").on("click",function(){
		...
		var obj = $(this);
		window.location.href=path+"/Bill/viewBill/"+ obj.attr("billid");
	});
	
	$(".modifyBill").on("click",function(){
		var obj = $(this);
		window.location.href=path+"/Bill/toModifyBillPage/"+ obj.attr("billid");
	});
	$('#no').click(function () {
		cancleBtn();
	});
